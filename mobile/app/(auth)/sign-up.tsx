...
export default function SignUpScreen() {
  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <Screen>
        <View style={styles.headingWrap}><Text style={styles.heading}>Create your RunWise account</Text><Text style={styles.copy}>One account can switch between customer and runner mode.</Text></View>
        <Card style={{ gap: 14 }}>
