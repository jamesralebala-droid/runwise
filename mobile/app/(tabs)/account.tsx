...
const styles = StyleSheet.create({
  ...
  method: { borderWidth: 1, borderColor: colors.border, borderRadius: radius.pill, paddingVertical: 8, paddingHorizontal: 11 },
  methodActive: { borderColor: colors.green, backgroundColor: colors.greenSoft },
  methodText: { color: colors.muted, fontWeight: '700', fontSize: 12 },
