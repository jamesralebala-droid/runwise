...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.gold, fontSize: 11, fontWeight: '900', letterSpacing: 1 },
  ...
  label: { color: colors.charcoal, fontWeight: '800', fontSize: 13 },
  moneyRow: { flexDirection: 'row', justifyContent: 'space-between' },
  money: { color: colors.charcoal, fontWeight: '700' },
  ...
  totalLabel: { color: colors.green, fontWeight: '900' },
  ...
  checkText: { flex: 1, color: colors.charcoal, lineHeight: 19 },
  timeline: { flexDirection: 'row', gap: 10, paddingVertical: 4 },
  dot: { width: 27, height: 27, borderRadius: 14, backgroundColor: colors.green, alignItems: 'center', justifyContent: 'center' },
  dotText: { color: colors.white, fontWeight: '900', fontSize: 11 },
  timelineTitle: { color: colors.charcoal, fontWeight: '800' },
  choiceWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  choice: { borderRadius: radius.pill, paddingVertical: 7, paddingHorizontal: 10, backgroundColor: colors.ivory, borderWidth: 1, borderColor: colors.border },
  ...
  bubbleName: { color: colors.green, fontSize: 10, fontWeight: '900' },
  bubbleText: { color: colors.charcoal, lineHeight: 19 },
  bubbleTime: { color: colors.muted, fontSize: 9, alignSelf: 'flex-end' },
  actionRow: { flexDirection: 'row', gap: 8 },
  nearby: { backgroundColor: colors.goldSoft, borderRadius: radius.sm, padding: 11, color: colors.charcoal, lineHeight: 19 },
