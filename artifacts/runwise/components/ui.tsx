...
export function AppButton({
  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => [
        styles.button,
        styles[`button_${variant}` as keyof typeof styles] as StyleProp<ViewStyle>,
    ...
    >
      {loading
        ...
        : <Text style={[styles.buttonText, styles[`buttonText_${variant}` as keyof typeof styles] as StyleProp<ViewStyle>]}>{title}</Text>}
    </Pressable>
  );
}
...
export function Pill({ text, tone = 'neutral' }: { text: string; tone?: 'neutral' | 'success' | 'warning' | 'danger' | 'gold' }) {
  return (
    <View style={[styles.pill, styles[`pill_${tone}` as keyof typeof styles] as StyleProp<ViewStyle>]}>
      <Text style={[styles.pillText, styles[`pillText_${tone}` as keyof typeof styles] as StyleProp<ViewStyle>]}>{text}</Text>
    </View>
  );
}
